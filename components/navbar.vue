                        ...
                        <div class="flex items-center justify-start rtl:justify-end">
                              ...
                              <NuxtLink to="/" class="flex ms-2 md:me-24">
                                    <img src="/icons/icons8-apple-logo-64.png" class="h-8 me-3"
                                          alt="FlowBite Logo" />
                                    <span
                                          class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Shopping Mart</span>
                              </NuxtLink>
                        </div>
                  ...
                  <ul class="space-y-2 font-medium">
                        ...
                        <li v-if="Loginuser.userlogin">
                              <NuxtLink to="/cart"
                                    ...
                                    <span
                                          class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ cartItems.cartItems.length  }}</span>
                              </NuxtLink>
                        </li>
                        <!-- User Page -->
                        <li>
                        ...
                        <li>
                              <NuxtLink to="/login"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap" v-if="!Loginuser.userlogin">Sign In</span>
                                    <span class="flex-1 ms-3 whitespace-nowrap text-red-500" v-else @click="logoutUser()">Logout</span>
                              </NuxtLink>
                        </li>
                        <!-- Register Page -->
                        <li v-if="!Loginuser.userlogin">
...
onMounted(() => {
      mobileSideBar.value = width.value >= 766 ? true : false
})
