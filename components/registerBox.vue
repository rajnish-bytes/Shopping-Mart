          ...
          <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                      ...
                      <div class="mt-6 grid grid-cols-3 gap-3">
                            ...
                            <div v-for="svg in mediaImg" key="svg" class="w-full flex items-center justify-center px-8 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                <img 
                                class="h-5 w-5"
                                :src="svg" alt="">  
                            </div>
