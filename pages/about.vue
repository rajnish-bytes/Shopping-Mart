<template>
      ...
      <div class="max-w-5xl pt-52 pb-24 mx-auto">
        <h1 class="text-80 text-center font-4 lh-6 ld-04 font-bold  mb-6">
      ...
      <p className="mx-auto text-xl text-center  font-normal leading-relaxed fs521 lg:w-2/3">
        Here is our collection of new fashion and trendy degines 
      </p>
      <br><hr><br>
      <section class="relative pb-24 bg-slate-200">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div class="py-24 md:py-36">
            <h1 class="mb-5 text-6xl font-bold ">
              Subscribe to our Mart
            </h1>
            <h1 class="mb-9 text-2xl font-semibold ">
              Enter your email address and get our Premium Shopping.
            </h1>
            <input
              type="email"
              ...
              name="email"
              autocomplete="email"
              class="border border-gray-600 w-1/4 pr-2 pl-2 py-3 mt-2 rounded-md text-gray-100 font-semibold hover:border-gray-700 bg-black"
            />
            <a
