            ...
            <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                  ...
                  <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                        <div class="mb-2 flex justify-between">
                              ...
                              <p class="text-gray-700">${{ cartItems.totalPrice }}</p>
                        </div>
                        <div class="flex justify-between">
                              <p class="text-gray-700">Shipping</p>
                              <p class="text-gray-700">${{ Math.floor(shipping) }}</p>
                        </div>
                        <hr class="my-4" />
                        <div class="flex justify-between">
                              <p class="text-lg font-bold">Total</p>
                              <div class="">
                                    <p class="mb-1 text-lg font-bold">${{ Math.floor(cartItems.totalPrice + shipping) }} USD</p>
...
const shipping = computed(()=> cartItems.totalPrice / 6)
